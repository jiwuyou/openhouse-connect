...
export function Card({ children, className, hover }: CardProps) {
  return (
    <div
      className={cn(
        'rounded-xl p-4 sm:p-5 transition-all duration-200 animate-float-in min-w-0',
...
export function StatCard({ label, value, accent }: StatCardProps) {
  return (
    <Card hover>
      <p className="text-[11px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide truncate">
        {label}
      </p>
      <p
        className={cn(
