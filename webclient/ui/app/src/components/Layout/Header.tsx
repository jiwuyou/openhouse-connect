...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  const btnCls = cn(
    'p-2 min-h-10 min-w-10 rounded-lg transition-all duration-200 inline-flex items-center justify-center',
  ...
  return (
    <header
      className={cn(
        'h-14 flex items-center justify-between gap-2 px-3 sm:px-4 shrink-0',
    ...
    >
      ...
      <div className="flex items-center justify-end gap-1 ml-auto">
        ...
        <button
          ...
          onClick={logout}
          className={cn(
            'p-2 min-h-10 min-w-10 rounded-lg transition-all duration-200',
