    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select
          ...
          className="min-w-0 flex-1 sm:flex-none px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent/50"
        >
            ...
            <Link key={`${s._project}-${s.id}`} to={`/sessions/${s._project}/${s.id}`}>
              <div className={cn(
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span className="text-[10px] text-gray-400 sm:ml-auto">{s.history_count} msgs</span>
                </div>
              </div>
            </Link>
          ))}
