    ...
    <div className="space-y-4 animate-fade-in">
          ...
          {jobs.map(job => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3 flex-wrap">
                <span className="inline-flex items-center gap-1 text-[11px] font-mono bg-accent/10 text-accent px-2 py-0.5 rounded-md min-w-0">
                  <Clock size={10} />
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-3 border-t border-gray-100 dark:border-white/[0.06] flex-wrap">
            <Button variant="secondary" className="max-sm:flex-1" onClick={() => setShowForm(false)}>{t('common.cancel')}</Button>
            <Button className="max-sm:flex-1" onClick={handleSave} loading={saving}>
