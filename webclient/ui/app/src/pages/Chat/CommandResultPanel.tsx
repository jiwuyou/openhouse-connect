...
export default function CommandResultPanel({ result, onClose, onCardAction }: Props) {
  ...
  return (
    <>
      ...
      <div className={cn(
        'fixed inset-x-0 bottom-0 h-[86dvh] z-50 flex flex-col rounded-t-2xl overflow-hidden',
        'sm:top-0 sm:right-0 sm:left-auto sm:bottom-auto sm:h-full sm:w-[400px] sm:max-w-[90vw] sm:rounded-t-none',
        ...
        {/* Header */}
        <div className="flex items-center justify-between gap-3 px-4 sm:px-5 h-14 border-b border-gray-100 dark:border-white/[0.06] shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 min-h-10 min-w-10 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/[0.06] transition-colors"
          >
            <X size={16} />
          </button>
        </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 sm:py-5 safe-bottom">
