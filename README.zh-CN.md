...
<p align="center">
  <b>OpenHouse Connect</b> 是我们面向 OpenHouse 工作流打造的移动端优先网页客户端与 Agent 桥接项目。<br/>
  它希望用户可以直接在手机浏览器里和编码 Agent 对话、查看生成的图片与文件，<br/>
  并通过轻量的 Web 前端持续管理项目会话。
</p>

<p align="center">
  本项目基于原始的 <b>cc-connect</b> 项目演进而来；原项目的核心能力是把本地 AI Agent<br/>
  如 Claude Code、Codex、Gemini CLI、Cursor、OpenCode 等桥接到各类聊天平台。<br/>
  OpenHouse Connect 保留这一基础能力，同时尤其注重 <b>移动端网页客户端体验</b>：<br/>
  响应式布局、稳定的图片/文件投递、多前端入口，以及适合触控操作的日常使用体验。
</p>
